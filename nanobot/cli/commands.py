...
def gateway(
    ...
    agent = AgentLoop(
        ...
        searxng_base_url=config.tools.web.search.searxng_base_url,
        searxng_language=config.tools.web.search.searxng_language,
        searxng_engines=config.tools.web.search.searxng_engines,
